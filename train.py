...
from cinn_pfas.model import PINNModel
from cinn_pfas.integrator import RungeKuttaIntegratorCell
from cinn_pfas.loss import create_loss_fn
...
def main():
    ...
    output_path = os.path.join(results_dir, 'HPINN_minimal_model_exp.png')
